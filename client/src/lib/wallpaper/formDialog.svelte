<script>
  ...
  import { WButton } from "../../components/w_component/index";
      ...
      >
        ...
        <BeFormItem label="链接地址" prop="url">
          <div style="display: flex">
            ...
            {#if form.url_type === '1'}
              <WButton type="primary" on:click={()=>handleIsImg(form.url)} loading={isInspec}
                       style="margin-left: 10px">{isInspec ? "检查中" : '检查'}</WButton>
            {/if}
          </div>
        </BeFormItem>
