...
exports.WallpaperTypeModel = void 0;
/*
* Author:dinglong
* DateTime:2024/1/7 上午 12:19
*/
var sequelize_typescript_1 = require("sequelize-typescript");
var WallpaperTypeModel = function () {
    ...
    var WallpaperTypeModel = _classThis = /** @class */ (function (_super) {
        __extends(WallpaperTypeModel_1, _super);
        function WallpaperTypeModel_1() {
            ...
            _this.cover_url = __runInitializers(_this, _cover_url_initializers, void 0);
            _this.cover_type = __runInitializers(_this, _cover_type_initializers, void 0);
            _this.create_time = __runInitializers(_this, _create_time_initializers, void 0);
            return _this;
        }
        return WallpaperTypeModel_1;
    }(_classSuper));
    __setFunctionName(_classThis, "WallpaperTypeModel");
    (function () {
        var _a;
        ...
        _cover_url_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING })];
        _cover_type_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: 0 })];
        ...
        WallpaperTypeModel = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return WallpaperTypeModel = _classThis;
}();
exports.WallpaperTypeModel = WallpaperTypeModel;
