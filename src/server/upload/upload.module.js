            ...
            imports: [
                platform_express_1.MulterModule.register({
                    storage: (0, multer_1.diskStorage)({
                        destination: upload_utils_1.HandleDestination, // 文件路径处理回调
                        filename: upload_utils_1.HandleFilename // 文件名称处理回调
                    }),
                    fileFilter: upload_utils_1.HandleFileFilter // 文件校验处理回调
                }),
            ],
