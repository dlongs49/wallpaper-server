...
var upload_utils_1 = require("./upload.utils");
var UploadService = function () {
    ...
    var UploadService = _classThis = /** @class */ (function () {
        ...
        UploadService_1.prototype.uploadAvatarSer = function (files) {
            throw new http_response_1.ResSuccess((0, upload_utils_1.JsonFile)(files[0]));
        };
        UploadService_1.prototype.uploadWallpaperSer = function (files) {
            throw new http_response_1.ResSuccess((0, upload_utils_1.JsonFile)(files[0]));
        };
